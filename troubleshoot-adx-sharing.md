...
In order to delete the symbolink link and make data unavailable to the consumer, you will need to either delete the dataset or the dataset mapping prior to deleting the share. This is a current product limitation which will be updated in the near future. If you have already deleted the share, please contact azdatasharesupport@microsoft.com for instructions on how to delete the symbolink link via script.
